                                            ...
                                            ?>
                                                <tr>
                                                    ...
                                                    <td>
                                                        ...
                                                        <a type="button" class="btn btn-danger btn-icon-text" style="width: 120px" href="deleteemployee.php?id=<?= $row['id'] ?>" onclick="return confirm('Bạn có muốn xóa sản phẩm này không?')">
