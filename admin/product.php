...
if (isset($_COOKIE["user"])) {
  ...
  if ($permission == 1 || $permission == 0) {
    ...
    $baseQuery = "SELECT sanpham.id, sanpham.ten, danhmuc.danhmuc, nhacungcap.ten as nhacungcap, sanpham.gia, sanpham.anh1, sanpham.anh2, sanpham.anh3, sanpham.status  FROM sanpham INNER JOIN danhmuc ON sanpham.id_danhmuc = danhmuc.id_dm INNER JOIN nhacungcap ON sanpham.id_nhacungcap = nhacungcap.id";
