                                            ...
                                            ?>
                                                <tr class="addfont">
                                                    ...
                                                    <td>
                                                        ...
                                                        <a type="button" class="btn btn-danger btn-icon-text" style="width: 120px" href="deletesupplier.php?id=<?= $row['id'] ?>" onclick="return confirm('Bạn có muốn xóa tin tức này không?')">
