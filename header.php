                        ...
                        <div>
                            <a class="" href="cart.php" id="navbarDropdown3" role="button"> <!-- data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" -->
                                ...
                                if (isset($_COOKIE["user"])) {
                                    ...
                                    if (rowCount("SELECT * FROM donhang WHERE id_taikhoan=$id_nguoidung and status=0") > 0) {
                                        foreach (selectAll("SELECT * FROM donhang WHERE id_taikhoan=$id_nguoidung and status=0") as $items) {
                                            $id_donhang = $items['id'];
                                        }
