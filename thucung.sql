...
(3, 'vutuananh@gmail.com', 'Vu06102001', 'Vũ Tuấn Anh', '', '', '', 1, 0, 0),
(4, 'vuthithao@gmail.com', 'Vu06102001', 'Vũ Thị Thảo', '', '', '', 1, 0, 0);
...
--
-- Các ràng buộc cho bảng `taikhoan_quyen`
--
ALTER TABLE `taikhoan_quyen`
  ADD CONSTRAINT `taikhoan_quyen_ibfk_1` FOREIGN KEY (`id_taikhoan`) REFERENCES `taikhoan` (`id`),
  ADD CONSTRAINT `taikhoan_quyen_ibfk_2` FOREIGN KEY (`id_quyen`) REFERENCES `quyen` (`id`);
COMMIT;
